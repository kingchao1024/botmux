...
export const messages: Record<string, string> = {
  ...
  'cmd.fork.image_unavailable': 'Image preview unavailable. View the original in the parent topic.',
  'cmd.fork.task_title': 'Fork task',
  ...
  'cmd.cot.on_master_off': '🧠 Restored for this chat, but the bot-level master switch is off — run /botconfig set cotEnabled on before bubbles will appear.',
  ...
  'cmd.cot.status_master_off': '🔕 Thinking-process messages: bot-level master switch is off. Enable via /botconfig set cotEnabled on (this chat is not individually muted).',
  ...
  'help.cot': '/cot        - Thinking-process message switch (this chat): /cot off to mute, /cot on to restore, /cot show for a one-shot peek, /cot for status (bot-level master switch: /botconfig cotEnabled)',
